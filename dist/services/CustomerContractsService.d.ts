...
export declare class CustomerContractsService {
     ...
     * @throws ApiError
     */
    static lookupCustomerOrderContract(requestBody: LookupCustomerOrderContractInputAmarantSalesCustomerContractLookupOrderInputDto): CancelablePromise<AmarantSalesCustomerContractOrderLookupResultOutputDto>;
    /**
